        ...
        >
            <div className="contact-v2__left">
                ...
                <p className="contact-v2__lead">
                    Ready to buy, sell, or invest? Share a few details and
                ...
                <div className="contact-v2__list">
                    <div className="contact-v2__item">
                        ...
                        <div>
                            ...
                            <span className="contact-v2__value">
                                {c.address}
                            </span>
                        </div>
                    </div>
                    <div className="contact-v2__item">
                        <div className="contact-v2__icon" aria-hidden="true">
                            <svg
                                ...
                                strokeWidth="1.5"
                            >
                                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.36 12a19.79 19.79 0 0 1-3.15-8.57A2 2 0 0 1 3.22 1h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.09 8.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 21 16z" />
                            </svg>
                        </div>
                        <div>
                            <p className="contact-v2__label">
                                WhatsApp / Phone
                            </p>
                            <a
                                href={c.whatsapp_href}
                                className="contact-v2__value"
                            >
                                {c.phone_display}
                            </a>
                        </div>
                ...
                <form className="contact-v2__form" onSubmit={submit}>
                    ...
                    <div className="contact-v2__field">
                        ...
                        <textarea
                            ...
                            placeholder="Describe your requirements, timeline…"
                        />
                    </div>
