...
export const DEFAULTS = {
    ...
    about: {
        ...
        p2: "Spaces And Beyond Real Estate LLC is not a typical brokerage. We are strategic partners, bringing data driven insights, international networks, and over a decade of on-ground market expertise to every client relationship.",
    },
    awards: {
    ...
    contact: {
        ...
        address: "Office No. C-02-208, Building Owned by Saeed Bin Jumaa Bin Saeed Al Henai, Al Nahda 2, Dubai, UAE",
    ...
    team: [
        {
            ...
            name_line2: "",
            bio: "I bring a uniquely analytical and globally informed perspective to real estate. Since relocating to Dubai in 2007, I have witnessed, and actively participated in, the city's remarkable transformation into a leading global property hub. My journey began as a property investor in 2014, and I have since led transactions exceeding $100 million in property sales. Having lived in seven countries and speaking four languages which are Arabic, English, Russian, and German, I bring a truly international outlook to every client relationship, rooted in deep market knowledge and a commitment to long-term trust.",
            photo: "/images/zaid.jpeg",
            cred_value: "$350M+",
        ...
        },
        {
            ...
            name_line2: "",
            bio: "I bring precision, discipline, and strategic thinking to Dubai real estate. I’ve lived in Dubai since 2006 and entered real estate as an investor in 2014, before moving into brokerage in 2020. Since then, I’ve closed over AED 350 million in transactions, building my expertise from both sides of the table as an investor and an advisor. Having lived across six countries and speaking Arabic, English, and Russian, I understand more than property. I understand capital, culture, people, and how global investors make decisions. Today, as Founder and Operations Manager, I lead from the front identifying opportunities, timing the market, structuring deals, and positioning clients ahead of the curve .My approach is simple: protect capital, maximize returns, and execute without compromise. I don’t sell properties. I make strategic real estate decisions happen.",
